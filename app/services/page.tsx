...
export const metadata: Metadata = {
  ...
  description:
    '13+ interior design services: home interior design, modular kitchen, bedroom, wardrobe, false ceiling, TV unit, office interior, commercial spaces, and complete turnkey solutions. Serving Mumbai.',
  keywords:
  ...
  openGraph: {
    title: 'Interior Design Services — Home, Kitchen, Office & Turnkey | SK Interior',
    description:
